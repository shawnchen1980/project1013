# -*- coding: utf-8 -*-
"""
Created on Fri Nov 15 13:44:17 2019
...
print("girl shape is ",girl.shape)
...
#     model.add(Conv2D(filter1,ke_width,ke_height,kernel_initializer = keras.initializers.Constant(value=0.12),input_shape= girl.shape,name='conv_1'))
     model.add(Conv2D(filter1,ke_width,ke_height,input_shape= girl.shape,name='conv_1'))
...
print(conv_girl.shape)

visualize(conv_girl[0,:,:,0:2])